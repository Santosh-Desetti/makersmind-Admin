        ...
        <div className="card-body d-flex align-items-center justify-content-between flex-wrap row-gap-3">
          <div className="d-flex align-items-center flex-sm-nowrap flex-wrap row-gap-3">
            ...
            <div className="flex-fill">
              ...
              <span className="d-block mb-3 fs-13">MBBS, M.D, Cardiology</span>
          ...
          <div>
            ...
            <h6 className="fs-18 fw-bold mb-3">
              $499 <span className="fw-normal text-body fs-14"> / 30 Min</span>
            </h6>
            <a href="appointment-calendar.html" className="btn btn-primary">
                ...
                <div className="tab-content" id="pills-tabContent">
                  ...
                  >
                    <div className="d-flex align-items-center flex-wrap gap-2">
                      <a
                        href="#"
                        className="d-inline-flex align-items-center bg-light rounded flex-fill text-center justify-content-center p-1 text-body"
                      >
                        11:30 AM - 12:30 PM
                      </a>
                      <a
              ...
              <div className="card-body">
                ...
                <div className="mb-3">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <h6 className="mb-0 fw-bold">Top Doctor Award (2023)</h6>
                  </div>
                  <p>
              ...
              <div>
                <div className="d-flex align-items-center mb-3">
                  <span className="avatar rounded-circle bg-light text-dark fs-16 flex-shrink-0 me-2">
                    <i className="ti ti-file text-body" />
                  </span>
                  <div>
                ...
                <div className="d-flex align-items-center mb-3">
                  <span className="avatar rounded-circle bg-light text-dark fs-16 flex-shrink-0 me-2">
                    <i className="ti ti-phone text-body" />
                  </span>
                  <div>
                ...
                <div className="d-flex align-items-center mb-3">
                  <span className="avatar rounded-circle bg-light text-dark fs-16 flex-shrink-0 me-2">
                    <i className="ti ti-mail text-body" />
                  </span>
                  <div>
                ...
                <div className="d-flex align-items-center mb-3">
                  <span className="avatar rounded-circle bg-light text-dark fs-16 flex-shrink-0 me-2">
                    <i className="ti ti-map-pin-check text-body" />
                  </span>
                  <div>
                ...
                <div className="d-flex align-items-center mb-3">
                  <span className="avatar rounded-circle bg-light text-dark fs-16 flex-shrink-0 me-2">
                    <i className="ti ti-calendar-event text-body" />
                  </span>
                  <div>
                ...
                <div className="d-flex align-items-center mb-3">
                  <span className="avatar rounded-circle bg-light text-dark fs-16 flex-shrink-0 me-2">
                    <i className="ti ti-droplet text-body" />
                  </span>
                  <div>
                ...
                <div className="d-flex align-items-center mb-3">
                  <span className="avatar rounded-circle bg-light text-dark fs-16 flex-shrink-0 me-2">
                    <i className="ti ti-user-check text-body" />
                  </span>
                  <div>
                    <h6 className="fw-semibold fs-13 mb-1">
                      Year of Experience
