                  ...
                  <div className="row row-gap-3 mb-2">
                    <div className="col-md-3 col-sm-6">
                      <div className="bg-light border p-2 text-center rounded-2">
                        <p className="mb-1 text-body text-truncate">
                        ...
                        <div className="d-flex align-items-center mb-3">
                          ...
                          <div>
                            <h6 className="fs-14 mb-1 text-truncate">
                              <a href="doctor-details.html" className="fw-semibold">
                                Dr. Alex Morgan
                              </a>
                            </h6>
                ...
                <div className="card-body">
                  ...
                  <div className="mb-3 bg-light p-3 rounded-2 d-flex align-items-center justify-content-between">
                    <div>
                      ...
                      <p className="mb-0 text-body text-truncate">
                        <i className="ti ti-calendar-time me-1 text-body" /> Wed, 05
                        Apr 2025, 06:30 PM
                      </p>
                    </div>
                  ...
                  <div className="mb-3 bg-soft-danger p-3 rounded-2 d-flex align-items-center justify-content-between">
                    <div>
                      ...
                      <p className="mb-0 text-truncate">
                        <i className="ti ti-calendar-time me-1 text-dark" /> Wed, 05
                        Apr 2025, 04:10 PM
                      </p>
                    </div>
                    <div className="avatar-list-stacked avatar-group-sm event flex-shrink-0">
                  ...
                  <a href="appointments.html" className="btn btn-light w-100">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-center flex-wrap justify-content-center gap-2 mt-3">
                    ...
                    <p className="d-flex align-items-center mb-0 fs-13">
                      ...
                      <span className="text-dark fw-semibold me-1">121</span> Neurolgy
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="card-body">
                  ...
                  <div className="overflow-auto">
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <div className="flex-shrink-0 ms-2">
                        <a href="#" className="btn btn-primary btn-sm py-1">
                          Book Now
                        </a>
                      </div>
                    </div>
            ...
            <div className="col-xl-4 col-lg-6 d-flex">
              <div className="card shadow-sm flex-fill w-100">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-3">
                    <div>
                      <p className="fw-semibold mb-1 text-dark">Dental Surgery</p>
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-0">
                    <div>
                      <p className="fw-semibold mb-1 text-dark">General Medicine</p>
                    ...
                    <table className="table border">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              <a href="patient-details.html" className="avatar me-2">
                                <img
            ...
            <div className="col-xl-4 d-flex">
              <div className="card shadow-sm flex-fill w-100">
                <div className="card-header d-flex align-items-center justify-content-between">
                  ...
                  <a href="patients.html" className="btn fw-normal btn-outline-white">
                    View All
                  </a>
                </div>
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <h6 className="fs-14 mb-1 text-truncate">
                          <a href="patient-details.html" className="fw-medium">
                            Jesus Adams
                          </a>
                        </h6>
                        <p className="mb-0 fs-13 text-truncate">Total Paid : $6589</p>
                      </div>
                    </div>
                  ...
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <p className="mb-0 fs-13 text-truncate">Total Paid : $5632</p>
                      </div>
                    </div>
                    <span className="badge fw-medium badge-soft-primary border border-primary flex-shrink-0">
                      60 Appointments
                  ...
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <p className="mb-0 fs-13 text-truncate">Total Paid : $4125</p>
                      </div>
                    </div>
                    <span className="badge fw-medium badge-soft-primary border border-primary flex-shrink-0">
                      40 Appointments
                  ...
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <p className="mb-0 fs-13 text-truncate">Total Paid : $3140</p>
                      </div>
                    </div>
                    <span className="badge fw-medium badge-soft-primary border border-primary flex-shrink-0">
                      25 Appointments
                  ...
                  <div className="d-flex justify-content-between align-items-center mb-0">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <p className="mb-0 fs-13 text-truncate">Total Paid : $2654</p>
                      </div>
                    </div>
                    <span className="badge fw-medium badge-soft-primary border border-primary flex-shrink-0">
                      25 Appointments
              ...
              <div className="card shadow-sm flex-fill w-100">
                ...
                <div className="card-body">
                  <div className="d-flex justify-content-between mb-3">
                    <div className="d-flex align-items-center">
                      <a href="doctor-details.html" className="avatar flex-shrink-0">
                        <img
                      ...
                      <div className="ms-2">
                        <div>
                          <h6 className="fw-semibold text-truncate mb-1 fs-14">
                            <a href="doctor-details.html">James Allaire</a>
                          </h6>
                  ...
                  <div className="d-flex justify-content-between mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                        <div>
                          <h6 className="fw-semibold text-truncate mb-1 fs-14">
                            <a href="doctor-details.html">Esther Schmidt</a>
                          </h6>
                          <p className="fs-13 mb-0 text-truncate">
                  ...
                  <div className="d-flex justify-content-between mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                        <div>
                          <h6 className="fw-semibold text-truncate mb-1 fs-14">
                            <a href="doctor-details.html">Valerie Padgett</a>
                          </h6>
                          <p className="fs-13 mb-0 text-truncate">
                  ...
                  <div className="d-flex justify-content-between mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                        <div>
                          <h6 className="fw-semibold text-truncate mb-1 fs-14">
                            <a href="doctor-details.html">Diane Nash</a>
                          </h6>
                          <p className="fs-13 mb-0 text-truncate">1 Day - Not Well</p>
                        </div>
                      </div>
                    </div>
                    <div className="d-flex align-items-center">
                  ...
                  <div className="d-flex justify-content-between mb-0">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                        <div>
                          <h6 className="fw-semibold text-truncate mb-1 fs-14">
                            <a href="doctor-details.html">Sally Cavazos</a>
                          </h6>
                          <p className="fs-13 mb-0 text-truncate">
